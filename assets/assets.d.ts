...
type characters = 'bandit' | 'banditLeader' | 'banditoldman' | 'bat' | 'battleEffects' | 'bear' | 'gnomeforest' | 'howard' | 'lumberjack' | 'paladin' | 'wolf'
